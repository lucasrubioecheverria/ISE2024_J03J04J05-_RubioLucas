...
/* Last-Modified: Wed, 21 Feb 2024 10:31:28 GMT */
const uint32_t imageLastModified = 1708511488U;

static const uint8_t imageFileData[25815U] = {
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0xCEC97D75U, &imageFileData[11513U] },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[13661U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[14912U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[15556U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[18372U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[19761U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[20899U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[22686U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[25694U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[25815U] }
};
